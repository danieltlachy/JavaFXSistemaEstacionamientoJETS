...
public class FXMLCobrarTarjetaController implements Initializable {
    ...
    private void limpiarDatos(){
        ...
        pnDatosTarjeta.setVisible(false);
    ...
    private void mostrarDatos(){
        pnDatosTarjeta.setVisible(true);
    ...
    private void cargarDatosCobro(){
        ...
        lblTiempoTranscurrido.setText("Tiempo total en minutos: " + tiempo);
        lblTotalHoras.setText("Tiempo total en horas: " + tiempo/60);
        obtenerPrecio();
